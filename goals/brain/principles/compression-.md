# COMPRESSION_PROMPT v1.3 (Intelligence Delta Summarizer) — OPTIMIZED

Reference: [[../shared_core.md|Shared Core Principles]]
...
COMPRESSION RULES (never violate — reference shared_core):
