...
- [[toggles.md|Toggles]] (centralized — parsed by arbos_manager)
- [[metrics.md|Metrics]] (aha_strength, wiki_contribution_score, network_plasticity, coherence_efficiency, heterogeneity_deltas)

## Grail Patterns (auto-promoted)
[[grail_patterns/]]

**Last compressed**: [auto-updated by MCTS compression runs]  
**brain_depth**: lean (default) — toggle in toggles.md
