    ...
    def add(self, text: str, metadata: Dict = None):
        ...
        enriched_meta = {
            **metadata,
            ...
            "heterogeneity": metadata.get("heterogeneity_score", 0.72)
        }
    ...
    def compress_low_value_fragment(self, node: str, decayed_score: float):
        ...
        try:
            if self.arbos and hasattr(self.arbos, 'harness'):
                ...
                if self.arbos and hasattr(self.arbos, '_write_fragment'):
                    self.arbos._write_fragment(
                        challenge_id=getattr(self.arbos, '_current_challenge_id', "current"),
